...
| 문서 ID | 문서명 | 경로 |
|---------|--------|------|
| DG02 | SW 아키텍처 설계서 | [docs/DG02-아키텍처설계서.md](docs/DG02-아키텍처설계서.md) |
| DG03 | 기술 스택 목록 | [docs/DG03-기술스택목록.md](docs/DG03-기술스택목록.md) |
| DG06 | 컴포넌트 설계서 | [docs/DG06-컴포넌트설계서.md](docs/DG06-컴포넌트설계서.md) |
| DG07 | 기능 설계서 | [docs/DG07-기능설계서.md](docs/DG07-기능설계서.md) |
| DG08 | 공통 코드 정의서 | [docs/DG08-공통코드정의서.md](docs/DG08-공통코드정의서.md) |

### 개발 문서 (DE)
| 문서 ID | 문서명 | 경로 |
|---------|--------|------|
| DE02 | 폴더 구조 | [docs/DE02-폴더구조.md](docs/DE02-폴더구조.md) |
| DE03 | 환경변수 템플릿 | [docs/DE03-환경변수템플릿.md](docs/DE03-환경변수템플릿.md) |
| DE04 | 의존성 목록 | [docs/DE04-의존성목록.md](docs/DE04-의존성목록.md) |
| DE05 | 라이선스 목록 | [docs/DE05-라이선스목록.md](docs/DE05-라이선스목록.md) |
| DE07 | 개발환경 구축 가이드 | [docs/DE07-개발환경구축가이드.md](docs/DE07-개발환경구축가이드.md) |
| DE08 | 배포 가이드 | [docs/DE08-배포가이드.md](docs/DE08-배포가이드.md) |
| DE09 | 빌드 가이드 | [docs/DE09-빌드가이드.md](docs/DE09-빌드가이드.md) |
