...
import styles from './phoneVerificationEditSection.module.scss'
...
interface PhoneVerificationEditSectionProps {
  currentPhone?: string
}

const PhoneVerificationEditSection = ({ currentPhone }: PhoneVerificationEditSectionProps) => {
  ...
  return (
    <section className={styles.container}>
      <h2 className={styles.title}>휴대폰 변경</h2>
...
export default PhoneVerificationEditSection
